...
const CreateCarListings = () => {
  ...
  return (
    <>
      <div className=" bg-createcars w-[100vw] h-[100vh] flex justify-center items-center flex-col gap-4 opacity-95">
        <p className="text-4xl font-bold text-white">Create Car Listings</p>
